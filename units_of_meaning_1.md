...
[^2]: This is an imperfect model, and it will probably need to be revised over time. However I am reminded of [Feynman diagrams](https://simple.wikipedia.org/wiki/Feynman_diagram) which are a way of organizing the math of particle physics. This model is attempting to do the same job, which is creating an easier to think about abstraction for how people build concepts.
